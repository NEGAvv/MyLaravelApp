...
export default function ActorEdit({ actor, auth }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-white-800 leading-tight break-words">{actor.name}</h2>}>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col sm:flex-row mb-6">
                        ...
                        <form onSubmit={handleSubmit} className="sm:w-2/3 md:w-3/4 p-4 sm:p-8">
                            <div className="mb-4">
